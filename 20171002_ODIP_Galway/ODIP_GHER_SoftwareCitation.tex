...
%\subtitle{}
\author[C.~Troupin]{C.~Troupin$^{\star}$, C.~Muñoz$^{\ast}$,\\ M.~A.~R\'{u}jula$^{\ast}$, J.~G.~Fern\'{a}ndez$^{\ast}$,\\ S.~Watelet$^{\star}$, A.~Barth$^{\star}$ \& J.-M.~Beckers$^{\star}$}
...
%--------------------------------------------------------------------------------------------------------------
\begin{frame}
\frametitle{Persistent identifiers everywhere}
\begin{tikzpicture}
...
\node[fill=LightGreen,text=black] (Science) at (9,7) {Science/expertise};
...
\onslide<2>{Let's work with ORCID and MarineID\\
...
\aiMendeley
\aiOpenAccess
\alert<2>{\aiOrcid} \onslide<2>{\includegraphics[height=.5cm]{marineID.png}}
...
\begin{figure}
\includegraphics[width=.95\textwidth]{codeocean.png}
\end{figure}
\end{frame}
...
\begin{figure}
\centering
\includegraphics[width=.4\textwidth]{zenodoHowToCite}
\end{figure}
}
...
\begin{column}{0.6\textwidth}  %%<--- here
    \begin{center}
     \includegraphics[width=0.95\textwidth]{0_socib_obs.png}
     \end{center}
\end{column}
...
\begin{figure}
     \includegraphics[width=0.75\textwidth]{gliderusers.png}
\end{figure}
\end{frame}
...
\begin{figure}
     \includegraphics[width=\textwidth]{softwareCitation_flowChart.png}
\end{figure}
\end{frame}
...
\Wider{
\begin{figure}
     \includegraphics[width=0.95\textwidth]{userexperience.png}
\end{figure}
}
\end{frame}
%-----------------------------------------------------------------------------------------------
...
\begin{figure}
\centering
\includegraphics[width=.6\textwidth]{wolfgangpauli.jpg}
\end{figure}
